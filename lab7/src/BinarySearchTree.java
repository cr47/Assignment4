...
public class BinarySearchTree<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    public void leftSubTree(E e) {
        TreeNode<E> root = getOne(e);
        ArrayList<E> list = new ArrayList<>();
        leftSubTree(list, root.left);
        for (E element : list) {
    ...
    public void leftSubTree(java.util.ArrayList<E> list, TreeNode<E> root) {
        if (root != null) {
            list.add(root.element);
            leftSubTree(list, root.left);
            leftSubTree(list, root.right);
        }

    }

        public void rightSubTree(E e) {
        TreeNode<E> root = getOne(e);
        ArrayList<E> list = new ArrayList<>();
        rightSubTree(list, root.right);
        for (E element : list) {
            System.out.print(element + " ");
        }
        System.out.println("");
    ...
    /* Returns an ArrayList containing all elements in preorder of the specified element’s left sub-tree, returns an empty ArrayList if no  such element exists. */
    public void rightSubTree(java.util.ArrayList<E> list, TreeNode<E> root) {
        if (root != null) {
            list.add(root.element);
            rightSubTree(list, root.left);
            rightSubTree(list, root.right);
        }
